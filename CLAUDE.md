...
- `workflow-kit` — Plan → build pipeline (feature-plan, implement-plan; implement-plan runs natively on Claude Code, with a host-binding layer for additional runtimes, and delegates PR creation to the consuming project's `/create-pr`)
